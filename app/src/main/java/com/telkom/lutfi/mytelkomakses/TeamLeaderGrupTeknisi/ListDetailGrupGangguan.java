    ...
    private class TeamViewHolder extends RecyclerView.ViewHolder {
        ...
        void deleteUser( final String nama, final String id) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ListDetailGrupGangguan.this);
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(ListDetailGrupGangguan.this, "Berhasil", Toast.LENGTH_LONG).show();
                                                finish();
                                                Intent intent = new Intent(ListDetailGrupGangguan.this, ListGrupGangguan.class);
                                                startActivity(intent);
                                            }
                                        }
                                    });
