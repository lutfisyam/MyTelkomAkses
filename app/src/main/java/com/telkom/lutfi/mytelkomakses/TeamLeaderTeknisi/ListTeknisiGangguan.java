...
public class ListTeknisiGangguan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = mFireStore.collection("user").whereEqualTo("jenis","teknisi_gangguan");

        FirestoreRecyclerOptions<User> options = new FirestoreRecyclerOptions.Builder<User>()
                .setQuery(query, User.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<User, ListTeknisiGangguan.UserViewHolder>(options) {
            @Override
            public void onBindViewHolder(ListTeknisiGangguan.UserViewHolder holder, int position, User model) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(ListTeknisiGangguan.this));
    }
    ...
    private class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        void deleteUser(final String email, final String pass, final String nama, final String id) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ListTeknisiGangguan.this);
    ...
    private class AddTeknisiDialog extends AlertDialog {
        ...
        protected AddTeknisiDialog(@NonNull Context context) {
            ...
            LayoutInflater inflater = LayoutInflater.from(ListTeknisiGangguan.this);
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            mFireStore.collection("user").document(newUid).set(new_user)
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isSuccessful()) {
                                                                Toast.makeText(ListTeknisiGangguan.this, "Berhasil menambahkan", Toast.LENGTH_LONG).show();
                                                                dismiss();
                                                            }
                                                        }
                                                    });
                                        } else {
                                            Toast.makeText(ListTeknisiGangguan.this, "Gagal menambahkan", Toast.LENGTH_LONG).show();
                                        }
                                    }
                                });
                    } else {
                        Toast.makeText(ListTeknisiGangguan.this, "Tolong lenkgapi form", Toast.LENGTH_LONG).show();
                    }
                }
            });
